#ifndef INPUTOIS_GLOBAL_H
#define INPUTOIS_GLOBAL_H
...
// Windows and pocket pc
	...
	*/
	...
	// Windows dll defines
	#if defined(INPUTOIS_EXPORTING) // Creating a dynamic library
		#define INPUTOIS_API __declspec(dllexport)
	#elif defined(INPUTOIS_STATIC) // Creating or using a static library
		#define INPUTOIS_API
	#else // Using the dynamic lib
		#define INPUTOIS_API __declspec(dllimport)
	#endif
